...
{{--<input type="text" name="q" value="{{ $q }}" class="form-control me-2" placeholder="Search name, email, phone, position">
...
<form action="{{ route('employee_delete') }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this employee?');">
@csrf
